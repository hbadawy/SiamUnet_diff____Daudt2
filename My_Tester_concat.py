...
if __name__ == "__main__":
    ...
    model = SiamUnet_conc(input_nbr=3, label_nbr=1)
    model=model.to(device)
    model.load_state_dict(torch.load("E://VS Projects//test_25-2-2025_FC//Training_Concat//checkpoint5-FocalTverskyLoss-20epochs//ResUnet19.pth"))

    test_results_path="E://VS Projects//test_25-2-2025_FC//Training_Concat//test_results5-FocalTverskyLoss-20epochs"
    ...
    Spec = TN/(TN+FP)
    print(f'OA={OA:.3f}, Precision={Precision:.3f}, Recall/Sensitivity={Recall:.3f}, Specificity={Spec:.3f}, IoU={IoU:.3f}, F1-score/Dice={F1_score:.3f}' )